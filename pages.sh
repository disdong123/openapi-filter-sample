...
redocly build-docs original/gitlab-latest.json --output=pages/gitlab-latest-dark.html --config redocly-dark.yaml
redocly build-docs original/jira-latest.json --output=pages/jira-latest-dark.html --config redocly-dark.yaml
...
redocly build-docs original/gitlab-latest.json --output=pages/gitlab-latest-light.html --config redocly-light.yaml
redocly build-docs original/jira-latest.json --output=pages/jira-latest-light.html --config redocly-light.yaml
